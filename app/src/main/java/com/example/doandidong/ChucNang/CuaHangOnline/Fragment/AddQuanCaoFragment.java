package com.example.doandidong.ChucNang.CuaHangOnline.Fragment;
...
import com.example.doandidong.Data.ChucNangThanhToan.DonGia;
import com.example.doandidong.Data.SanPham.DonViTinh;
import com.example.doandidong.R;
import com.example.doandidong.ChucNang.CuaHangOnline.Adapter.AdapterDonGia;
import com.example.doandidong.ChucNang.CuaHangOnline.Adapter.DanhSachSanPhamCoSanAdapter;
import com.example.doandidong.ChucNang.CuaHangOnline.Data.Product;
import com.example.doandidong.ChucNang.CustomDialogClass;
...
public class AddQuanCaoFragment extends Fragment implements View.OnClickListener {
    ...
    private ArrayList<com.example.doandidong.Data.Product> listProduct;
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot snapshot1 : snapshot.getChildren()){
                    ...
                    for (DataSnapshot snapshot2 : aaa.getChildren()){
                        com.example.doandidong.Data.Product product = snapshot2.getValue(com.example.doandidong.Data.Product.class);
