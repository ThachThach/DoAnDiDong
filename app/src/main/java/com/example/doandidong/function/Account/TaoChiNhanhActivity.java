...
import com.example.doandidong.Model.NhanVien_CaLam.CaLam;
import com.example.doandidong.Model.NhanVien_CaLam.ChamCong;
...
public class TaoChiNhanhActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setData() {
        ...
        if (nameStore.isEmpty()) {
            ...
            com.example.doandidong.database.ThongTinCuaHangSql thongTinCuaHangSqlDB = new com.example.doandidong.database.ThongTinCuaHangSql(TaoChiNhanhActivity.this,
